...
class LibraryBookForm extends StatefulWidget {
  final Book book;
  final bool isUpdating;

  const LibraryBookForm({Key key, this.isUpdating, this.book})
      : super(key: key);
  @override
  _LibraryBookFormState createState() => _LibraryBookFormState();
}

class _LibraryBookFormState extends State<LibraryBookForm> {
  ...
  validate() {
    if (_formKey.currentState.validate()) {
      ...
      if (isUpdating) {
        ...
        addBook(book.toJson()).then((response) {
